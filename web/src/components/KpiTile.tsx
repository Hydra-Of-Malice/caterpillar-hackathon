...
export function KpiTile({
  ...
  return (
    <div className={cx('panel flex flex-col justify-between gap-2 p-6', className)}>
      <div className="flex items-start justify-between gap-2">
        <span className="text-body-md text-on-surface-muted">{label}</span>
        {icon && <Icon name={icon} size={20} className="text-on-surface-muted" />}
      </div>
